...
- All scripts were written and troubleshooted across the period of July 2024 - August 2025 under the supervision of Dr. Ioannis Pappas. To run these scripts you may refer to the `Instructions_Scripts.md` file.

- Both the amyloid and tau PET pipelines described here are similar in logic to the ADNI standard protocols (also accessible via the LONI IDA):
